...
# -*- coding: utf-8 -*-
"""
Extract voxel count, volume and cluster count for segmented WMH from (multiple) NIfTI files, corresponding to
...
license = 'https://github.com/miac-research/MARS-WMH'
region = 'WMH'
regionSuffix = 'wmh'
