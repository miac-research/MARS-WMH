...
def create_html_with_png(fnPNG, fnHTML, df=None, text=None, aspect_ratio='auto'):
  import base64, os, re
  import pandas as pd
  import numpy as np
  ...
  '''
  style = style.replace('RATIO', f"{aspect_ratio}") # aspect ratio of the image
  ...
  <html>
    ...
    <body>
      <img class="image"; src="data:image/png;base64,{base64_image}">
      {text}
      {dfHTML}
    </body>
  </html>
